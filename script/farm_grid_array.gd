...
func encode_cell(cell: Cell):
	...
	encode_cell_property(cell.position, CELL_PROPERTIES.PLANT_TYPE_ID, cell.get_plant_id())
	encode_cell_property(cell.position, CELL_PROPERTIES.PLANT_GROWTH, cell.get_plant_growth())
	encode_cell_property(cell.position, CELL_PROPERTIES.PLANT_TURNS_ALIVE, cell.get_plant_turns_alive())
